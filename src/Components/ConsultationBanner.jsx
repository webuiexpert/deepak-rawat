...
function ConsultationBanner() {
  return (
    <div className="w-full bg-[#ffe88c]">
        ...
        <button className="lg:text-[18px]  font-bold bg-[#13a300] text-white hover:bg-transparent border border-transparent hover:border hover:border-[#391D5D] px-5 py-3 rounded-full">
          <Calendly />
        </button>
        </div>
